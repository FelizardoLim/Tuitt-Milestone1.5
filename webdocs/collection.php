	...
	foreach ($cars as $key => $entry) {
		...
		echo "<div class='col-xs-12 col-sm-6 col-lg-4 collectiondetails'>";
			echo "<div class='cdetails'>";
				...
				echo "<div class='col-xs-offset-11 col-xs-1'><a href='delete.php?key=$key'><span class='glyphicon glyphicon-remove'></span></a></div>";
				} else {
					echo "";
				}
				echo "<h3>".$name."</h3>";
				...
				// echo "<a href='delete.php?key=$key'><button class='col-xs-12 col-sm-4 btn btn-default glyphicon glyphicon-trash'></button></a>";
				} else {
					echo "";
						} 
			echo "</div>";
